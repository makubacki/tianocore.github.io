**DEPRECATION NOTICE:** This wiki has been replaced with a dedicated wiki in a GitHub repository that accepts contributions via pull requests. [More information](https://github.com/tianocore/edk2/discussions/11969).

New Location: https://github.com/tianocore/tianocore-wiki.github.io

This wiki is in a read-only state. Visit and contribute to the new wiki moving forward.
...
The latest [stable tag](https://github.com/tianocore/tianocore.github.io/wiki/EDK-II#stable-tags) of EDK II is [edk2-stable202508](https://github.com/tianocore/edk2/releases/tag/edk2-stable202602).
